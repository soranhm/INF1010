class VriAatter {
    ...
    public boolean gyldigTrekk(Kort kort) {
        if (kort == null) {
            return false;
        }
        // hvis ingen kort paa bordet, kan man legge hva som helst
        if (kortPaaBordet.erTom()) {
            return true;
        }
