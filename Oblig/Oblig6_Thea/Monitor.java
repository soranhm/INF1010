...
class Monitor{
    ...
    public int antallProdusenter;
    public int antallKonsumenter;
    private int ferdigProdusenter;
    private int ferdigKonsumenter;

    Liste<Melding> meldinger = new Koe<Melding>();

    private Lock lock = new ReentrantLock();
    private final Condition isemty = lock.newCondition();
    private final Condition op = lock.newCondition();
